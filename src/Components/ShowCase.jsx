...
function ShowCase(){
    ...
    return <div>
        <div style={{display: show == false ? "block" : ""}} className="bg-gradient-to-r text-white from-[#023047] to-black relative h-[505px] text-center py-[60px] ">

        <h1 className="text-5xl font-bold">Make your complaints way easier ever</h1>
        <p className="pt-10">We are commited to solve your complaints. Make any  complaints you could</p>
       
        <button onClick={handleOpen} className="bg-[#ffffff] text-xl font-bold text-[#023047] px-3 py-2 mt-10 rounded-md ">Make Complaint</button>
